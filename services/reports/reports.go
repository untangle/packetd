...
func createTables() {
	...
	_, err = db.Exec(
		`CREATE TABLE IF NOT EXISTS interface_stats (
					...
					interface_id int1,
					device_name text,
					combined_latency_1 real,
					combined_latency_5 real,
					combined_latency_15 real,
					combined_latency_variance real,
					...
					ping_timeout_1 real,
					ping_timeout_5 real,
					ping_timeout_15 real,
					ping_timeout_variance real,
					rx_bytes_1 real,
					rx_bytes_5 real,
					rx_bytes_15 real,
					rx_bytes_variance real,
					rx_packets_1 real,
					rx_packets_5 real,
					rx_packets_15 real,
					rx_packets_variance real,
					rx_errors_1 real,
					rx_errors_5 real,
					rx_errors_15 real,
					rx_errors_variance real,
					rx_drop_1 real,
					rx_drop_5 real,
					rx_drop_15 real,
					rx_drop_variance real,
					rx_fifo_1 real,
					rx_fifo_5 real,
					rx_fifo_15 real,
					rx_fifo_variance real,
					rx_frame_1 real,
					rx_frame_5 real,
					rx_frame_15 real,
					rx_frame_variance real,
					rx_compressed_1 real,
					rx_compressed_5 real,
					rx_compressed_15 real,
					rx_compressed_variance real,
					rx_multicast_1 real,
					rx_multicast_5 real,
					rx_multicast_15 real,
					rx_multicast_variance real,
					tx_bytes_1 real,
					tx_bytes_5 real,
					tx_bytes_15 real,
					tx_bytes_variance real,
					tx_packets_1 real,
					tx_packets_5 real,
					tx_packets_15 real,
					tx_packets_variance real,
					tx_errors_1 real,
					tx_errors_5 real,
					tx_errors_15 real,
					tx_errors_variance real,
					tx_drop_1 real,
					tx_drop_5 real,
					tx_drop_15 real,
					tx_drop_variance real,
					tx_fifo_1 real,
					tx_fifo_5 real,
					tx_fifo_15 real,
					tx_fifo_variance real,
					tx_collision_1 real,
					tx_collision_5 real,
					tx_collision_15 real,
					tx_collision_variance real,
					tx_carrier_1 real,
					tx_carrier_5 real,
					tx_carrier_15 real,
					tx_carrier_variance real,
					tx_compressed_1 real,
					tx_compressed_5 real,
					tx_compressed_15 real,
					tx_compressed_variance real)`)
