...
func createTables() {
	...
	_, err = db.Exec(
		`CREATE TABLE IF NOT EXISTS sessions (
			...
			application_predicted_id text,
			application_predicted_name text,
			application_predicted_confidence integer,
			application_predicted_protochain text,
			application_predicted_productivity text,
			application_predicted_threat text,
			application_predicted_category text,
