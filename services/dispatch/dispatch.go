...
// 1 - We give the stats plugin the highest priority so we can accurately calculate
//     the latency between the first client packet and the first server reply.
// 2 - The reporter plugin gets the second highest priority so it can create events
//     for capturing the data that is generated by the other plugins
// 3 - The rest of the plugins get called after everything more important

// StatsPriority ...
const StatsPriority = 1

// ReporterPriority ...
const ReporterPriority = 2

// CertfetchPriority ...
const CertfetchPriority = 3

// CertsniffPriority ...
const CertsniffPriority = 3
...
// ExamplePriority ...
const ExamplePriority = 3

// GeoipPriority ...
const GeoipPriority = 3

// RevDNSPriority ...
const RevDNSPriority = 3
